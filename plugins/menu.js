  ...
  try {
    ...
    if (teks == '404') {
      ...
      const sections = [
      {
        ...
        rows: [
          { title: ' 👨 OWNER BOT', description: "Nomor Pemilik Bot Chat P/Meminta Save Tidak Akan Di Respon", rowId: `.owner`
          { title: '| 🧾 | SEMUA PERINTAH', rowId: `${_p + command} all` },
          { title: '| 📝 | ABSEN & VOTE', rowId: `${_p + command} vote` },
          { title: '| 🎮 | GAME', rowId: `${_p + command} game` },
          { title: '| 🌱 | RPG', rowId: `${_p + command} rpg` },
          { title: '| 〽️ | XP', rowId: `${_p + command} xp` },
          { title: '| 🌠 | STICKER', rowId: `${_p + command} stiker` },
          ...
          { title: '| 🏨 | GRUOP', rowId: `${_p + command} grup` },
          ...
          { title: '| 🎙️ | PENGUBAH SUARA', rowId: `${_p + command} audio` },
          { title: '| 🤖 | JADI BOT', rowId: `${_p + command} jadibot` },
          { title: '| ❗ | INFO', rowId: `${_p +command} info` },
          { title: '| ❓ | TANPA KATAGORI', rowId: `${_p + command} tanpakategori` },
