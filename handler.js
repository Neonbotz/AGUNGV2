...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = namabot + ' 𝘼𝙜𝙪𝙣𝙜𝙭 𝙏𝙮𝙪𝙧𝙪»'
        global.colong1 = 'Ciss 📸'
        global.colong2 = '𝘼𝙜𝙪𝙣𝙜𝙭 𝙏𝙮𝙪𝙧𝙪»'
        global.kontak2 = [
        ['6287719424487', '𝘼𝙜𝙪𝙣𝙜𝙭 𝙏𝙮𝙪𝙧𝙪»', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'Private!!', true],
        ['14752659201', '𝙏𝙮𝙪𝙧𝙪»', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'Private!!', true],
        ['6281390413987', 'Sᴀᴄʜɪ-Bᴏᴛᴢ ♡︎', 'Bot WhatsApp', 'Nothing!', true],
        ['6281390413987', 'Sᴀᴄʜɪ-Bᴏᴛᴢ ♡︎', 'Bot WhatsApp', 'Nothing!', true],
        ['6281390413987', 'Sᴀᴄʜɪ-Bᴏᴛᴢ ♡', 'Bot WhatsApp', 'Nothing!', true],
        ['6281390413987', 'Sᴀᴄʜɪ-Bᴏᴛᴢ ♡', 'Bot WhatsApp', 'Nothing!', true],
        ['6281390413987', 'Sᴀᴄʜɪ-Bᴏᴛᴢ ♡', 'Bot WhatsApp', 'Nothing!', true],
        ['6281390413987', 'Sᴀᴄʜɪ-Bᴏᴛᴢ ♡', 'Bot WhatsApp', 'Nothing!', true],
        ['6281390413987', 'Sᴀᴄʜɪ-Bᴏᴛᴢ ♡', 'Bot WhatsApp', 'Nothing!', true],
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome Beban, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc ? String.fromCharCode(8206).repeat(4001) + groupMetadata.desc : '') :
                                (chat.sBye || this.bye || conn.bye || 'Bye Beban Lain Kali Jangan Masuk Lagi, @user!')).replace(/@user/g, '@' + user.split`@`[0])
...
global.thumb = 'https://telegra.ph/file/2ccdb3d40a29be3ba1dc2.jpg'
